...
#plant = WO_system()
    ...
    backtrack_1_mc += [backtrack_l]
print(2)
pickle.dump([X_opt_mc, y_opt_mc,TR_l_mc, xnew_mc, backtrack_1_mc], open('with_prior_with_exploration_ucb_noise2.p','wb'))
#-----------------------------------------------------------------------#
...
#plant = WO_system()
    ...
    backtrack_1_mc += [backtrack_l]
print(2)
pickle.dump([X_opt_mc, y_opt_mc,TR_l_mc, xnew_mc, backtrack_1_mc], open('with_prior_no_exploration_noise2.p','wb'))
#-----------------------------------------------------------------------#
