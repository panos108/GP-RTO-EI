...
#----------3ii) EI-PRIOR-KNOWN NOISE THAT IS WRONG----------#
#---------------------------------------------#
np.random.seed(0)
X_opt_mc = []
y_opt_mc = []
...
#plant = WO_system()
    ...
    backtrack_1_mc += [backtrack_l]
print(2)
pickle.dump([X_opt_mc, y_opt_mc,TR_l_mc, xnew_mc, backtrack_1_mc], open('with_prior_with_exploration_ei_noise_WRONG.p','wb'))
